...
class CategoriesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    child: Column(
      children: [
        Text("Good Morning\nHere is Some News For You",style: Theme.of(context).textTheme.bodyMedium,),
        SizedBox(height: 16.h,),
        Expanded(
          child: ListView.separated(
            separatorBuilder: (context, index) => SizedBox(height: 8.h,),
            itemCount: NewsCategory.newsCategories.length,
            itemBuilder: (context,index)=> CategoryItem(category: NewsCategory.newsCategories[index],index: index+1,),

...
import 'package:news_app/features/home/sources/all_articles_view_model.dart';
              ...
              children: [
                TextField(
                  ...
                  onChanged: (input) {
                    ...
                    input.isNotEmpty ?  allArticlesViewModel.loadAllArticles(input) : allArticlesViewModel.loadAllArticles("USA");
